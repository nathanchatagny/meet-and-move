      ...
      >
        <View style={styles.content}>
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.subtitle}>Rejoins Meet & Move</Text>
          </View>
          ...
          <TouchableOpacity style={styles.profilePictureContainer} onPress={pickImage}>
            {profilePicture ? (
              ...
              <View style={styles.profilePicturePlaceholder}>
                <Ionicons name="camera" size={24} color="#999999" />
                <Text style={styles.profilePictureSubtext}>Ajouter une photo</Text>
              </View>
            )}
          </TouchableOpacity>
